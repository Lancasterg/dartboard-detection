...
\end{figure}
\par
The performance of the model at this stage is remarkably worse than when detecting faces. Haar-like features may be best suited for detecting faces, rather than dartboards. 
\newpage
